...
public class TransactionAdviceConfig {
     ...
     * 定义切点路径
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.juan.shop.*ServiceImpl.*(..))";
    ...
    public TransactionInterceptor txAdvice() {
        ...
        txMap.put("del*", transactionAttribute1);
        txMap.put("edit*", transactionAttribute1);
        txMap.put("list*", transactionAttribute2);
